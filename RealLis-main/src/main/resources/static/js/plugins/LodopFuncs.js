...
function getLodop(oOBJECT, oEMBED) {
    ...
    try {
        ...
        if (LODOP.VERSION < "0.0.0.0") {
            if (!needCLodop())
                document.body.innerHTML = (is64IE ? strHtm64_Update : strHtmUpdate) + document.body.innerHTML;
        }
        //===如下空白位置适合调用统一功能(如注册语句、语言选择等):==
        LODOP.SET_LICENSES("宁波市科技园区明天医网科技有限公司", "ED93B23039558C46516A28F76ED01F21", "寧波市科技園區明天醫網科技有限公司", "3237B8D027B2FAED1E138F9773566799")
        //=======================================================
        return LODOP;
    } catch (err) {
