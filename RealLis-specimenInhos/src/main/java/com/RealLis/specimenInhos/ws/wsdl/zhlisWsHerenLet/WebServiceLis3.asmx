...
<wsdl:definitions xmlns:s="http://www.w3.org/2001/XMLSchema" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:tns="http://172.16.1.36" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" targetNamespace="http://172.16.1.36" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">
  <wsdl:types>
    <s:schema elementFormDefault="qualified" targetNamespace="http://172.16.1.36">
      ...
      <s:element name="LabFeeChargeResponse">
        <s:complexType>
          <s:sequence>
            <s:element minOccurs="0" maxOccurs="1" name="LabFeeChargeResult" type="s:string" />
          </s:sequence>
        </s:complexType>
      </s:element>
  ...
  <wsdl:message name="LabFeeChargeSoapIn">
    <wsdl:part name="parameters" element="tns:LabFeeCharge" />
  </wsdl:message>
  <wsdl:message name="LabFeeChargeSoapOut">
    <wsdl:part name="parameters" element="tns:LabFeeChargeResponse" />
  </wsdl:message>
  ...
  <wsdl:message name="LabFeeChargeHttpGetIn">
    <wsdl:part name="strBarCode" type="s:string" />
    <wsdl:part name="intChargeStatus" type="s:string" />
  </wsdl:message>
  <wsdl:message name="LabFeeChargeHttpGetOut">
    <wsdl:part name="Body" element="tns:string" />
  </wsdl:message>
  ...
  <wsdl:message name="LabFeeChargeHttpPostIn">
    <wsdl:part name="strBarCode" type="s:string" />
    <wsdl:part name="intChargeStatus" type="s:string" />
  </wsdl:message>
  <wsdl:message name="LabFeeChargeHttpPostOut">
    <wsdl:part name="Body" element="tns:string" />
  </wsdl:message>
  ...
  <wsdl:portType name="WebServiceLisSoap">
    ...
    <wsdl:operation name="SetBarOrderStatus">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">SetBarOrderStatus，向平台发送条形码状态！
    ...
    <wsdl:operation name="LabFeeCharge">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">SetBarOrderStatus，向平台发送收费交易！  intChargeStatus：1收费，-1退费</wsdl:documentation>
      <wsdl:input message="tns:LabFeeChargeSoapIn" />
      <wsdl:output message="tns:LabFeeChargeSoapOut" />
    </wsdl:operation>
  ...
  <wsdl:portType name="WebServiceLisHttpGet">
    ...
    <wsdl:operation name="LabFeeCharge">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">SetBarOrderStatus，向平台发送收费交易！  intChargeStatus：1收费，-1退费</wsdl:documentation>
      <wsdl:input message="tns:LabFeeChargeHttpGetIn" />
      <wsdl:output message="tns:LabFeeChargeHttpGetOut" />
    </wsdl:operation>
    <wsdl:operation name="WebTest">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/"> WebTest用于开发人员测试，参数传入时</wsdl:documentation>
  ...
  <wsdl:portType name="WebServiceLisHttpPost">
    ...
    <wsdl:operation name="LabFeeCharge">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">SetBarOrderStatus，向平台发送收费交易！  intChargeStatus：1收费，-1退费</wsdl:documentation>
      <wsdl:input message="tns:LabFeeChargeHttpPostIn" />
      <wsdl:output message="tns:LabFeeChargeHttpPostOut" />
    </wsdl:operation>
    <wsdl:operation name="WebTest">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/"> WebTest用于开发人员测试，参数传入时</wsdl:documentation>
  ...
  <wsdl:binding name="WebServiceLisSoap" type="tns:WebServiceLisSoap">
    ...
    <wsdl:operation name="LabFeeCharge">
      <soap:operation soapAction="http://172.16.1.36/LabFeeCharge" style="document" />
      <wsdl:input>
        <soap:body use="literal" />
      </wsdl:input>
      <wsdl:output>
  ...
  <wsdl:binding name="WebServiceLisSoap12" type="tns:WebServiceLisSoap">
    ...
    <wsdl:operation name="LabFeeCharge">
      <soap12:operation soapAction="http://172.16.1.36/LabFeeCharge" style="document" />
      <wsdl:input>
        <soap12:body use="literal" />
      </wsdl:input>
      <wsdl:output>
  ...
  <wsdl:binding name="WebServiceLisHttpGet" type="tns:WebServiceLisHttpGet">
    ...
    <wsdl:operation name="LabFeeCharge">
      <http:operation location="/LabFeeCharge" />
      <wsdl:input>
        <http:urlEncoded />
      </wsdl:input>
      <wsdl:output>
