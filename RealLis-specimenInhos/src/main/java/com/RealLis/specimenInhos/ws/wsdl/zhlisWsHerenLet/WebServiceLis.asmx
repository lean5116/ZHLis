...
<wsdl:definitions xmlns:s="http://www.w3.org/2001/XMLSchema" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:tns="http://172.16.1.36" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" targetNamespace="http://172.16.1.36" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">
  <wsdl:types>
    <s:schema elementFormDefault="qualified" targetNamespace="http://172.16.1.36">
      ...
      <s:element name="SendRiskValue">
        <s:complexType>
          <s:sequence>
            <s:element minOccurs="0" maxOccurs="1" name="strSeqNo" type="s:string" />
          </s:sequence>
        </s:complexType>
      </s:element>
      ...
      <s:element name="TransferHerenResponse">
        <s:complexType>
          <s:sequence>
            <s:element minOccurs="0" maxOccurs="1" name="TransferHerenResult" type="s:string" />
          </s:sequence>
        </s:complexType>
      </s:element>
      ...
      <s:element name="QueryCov19Response">
        <s:complexType>
          <s:sequence>
            <s:element minOccurs="0" maxOccurs="1" name="QueryCov19Result" type="s:string" />
          </s:sequence>
        </s:complexType>
      </s:element>
  ...
  <wsdl:message name="TransferHerenSoapIn">
    <wsdl:part name="parameters" element="tns:TransferHeren" />
  </wsdl:message>
  <wsdl:message name="TransferHerenSoapOut">
    <wsdl:part name="parameters" element="tns:TransferHerenResponse" />
  </wsdl:message>
  ...
  <wsdl:message name="QueryCov19SoapIn">
    <wsdl:part name="parameters" element="tns:QueryCov19" />
  </wsdl:message>
  <wsdl:message name="QueryCov19SoapOut">
    <wsdl:part name="parameters" element="tns:QueryCov19Response" />
  </wsdl:message>
  ...
  <wsdl:message name="SendRiskValueHttpGetIn">
    <wsdl:part name="strSeqNo" type="s:string" />
  </wsdl:message>
  ...
  <wsdl:message name="TransferHerenHttpGetIn">
    <wsdl:part name="strMessage" type="s:string" />
    <wsdl:part name="strDataType" type="s:string" />
  </wsdl:message>
  <wsdl:message name="TransferHerenHttpGetOut">
    <wsdl:part name="Body" element="tns:string" />
  </wsdl:message>
  ...
  <wsdl:message name="QueryCov19HttpGetIn">
    <wsdl:part name="strJson" type="s:string" />
  </wsdl:message>
  <wsdl:message name="QueryCov19HttpGetOut">
    <wsdl:part name="Body" element="tns:string" />
  </wsdl:message>
  ...
  <wsdl:message name="TransferHerenHttpPostIn">
    <wsdl:part name="strMessage" type="s:string" />
    <wsdl:part name="strDataType" type="s:string" />
  </wsdl:message>
  <wsdl:message name="TransferHerenHttpPostOut">
    <wsdl:part name="Body" element="tns:string" />
  </wsdl:message>
  ...
  <wsdl:message name="QueryCov19HttpPostIn">
    <wsdl:part name="strJson" type="s:string" />
  </wsdl:message>
  <wsdl:message name="QueryCov19HttpPostOut">
    <wsdl:part name="Body" element="tns:string" />
  </wsdl:message>
  <wsdl:portType name="WebServiceLisSoap">
    <wsdl:operation name="HelloWorld">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">----可用于测试服务是否正常。</wsdl:documentation>
      <wsdl:input message="tns:HelloWorldSoapIn" />
      <wsdl:output message="tns:HelloWorldSoapOut" />
    </wsdl:operation>
    <wsdl:operation name="zhLisHeren">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">----HIS与LIS进行交易的主要方法, strMessage消息主体，strDataType消息类型：HL7, JSON, XML 。</wsdl:documentation>
      <wsdl:input message="tns:zhLisHerenSoapIn" />
      <wsdl:output message="tns:zhLisHerenSoapOut" />
    </wsdl:operation>
    <wsdl:operation name="LabBarMake">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">----生成条形码方法，入参strPatientID为病历号：[VISIT_NUMBER]</wsdl:documentation>
      <wsdl:input message="tns:LabBarMakeSoapIn" />
      <wsdl:output message="tns:LabBarMakeSoapOut" />
    </wsdl:operation>
    <wsdl:operation name="LabDownInfoAll">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">----从HIS中下载信息总方法，支持的参数为：科室信息，职工信息，检验项目，收费项目。</wsdl:documentation>
    ...
    <wsdl:operation name="LabDownInfoDept">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">----从HIS中下载【 科室信息 】,无参数！</wsdl:documentation>
    ...
    <wsdl:operation name="LabDownInfoStaff">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">----从HIS中下载【职工信息】,无参数！</wsdl:documentation>
    ...
    <wsdl:operation name="LabDownInfoItem">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">----从HIS中下载【套餐项目】,无参数！</wsdl:documentation>
    ...
    <wsdl:operation name="LabDownInfoFee">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">----从HIS中下载【收费项目】,无参数！</wsdl:documentation>
    ...
    <wsdl:operation name="SetBarOrderStatus">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">----向平台发送条形码状态，strBarCode要求条码全码
         0=申请中(可退费)；1=已申请；2=条码已打印；3=标本已采集；5=标本已核收；
         6=已执行（上机）；D= 取消中；P初步报告；F=确认报告，11=LIS退回标本；H=标本已送出；Y=送达</wsdl:documentation>
    ...
    <wsdl:operation name="LabChargeFee">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">----向平台发送收费交易！ strBarCode要求全码， intChargeStatus：1收费，-1退费</wsdl:documentation>
      <wsdl:input message="tns:LabChargeFeeSoapIn" />
      <wsdl:output message="tns:LabChargeFeeSoapOut" />
    </wsdl:operation>
    <wsdl:operation name="SendRiskValue">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">----向平台发送危急值交易 ！strSeqNo对应L_TSXX.SEQNO</wsdl:documentation>
      <wsdl:input message="tns:SendRiskValueSoapIn" />
      <wsdl:output message="tns:SendRiskValueSoapOut" />
    </wsdl:operation>
    <wsdl:operation name="GetQueueNo">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">----取LIS排队叫号！参数strPatientId，病人标识号</wsdl:documentation>
      <wsdl:input message="tns:GetQueueNoSoapIn" />
      <wsdl:output message="tns:GetQueueNoSoapOut" />
    </wsdl:operation>
    <wsdl:operation name="TransferHeren">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">----用于向和仁直接转发消息，strMessage 消息内容，strDataType数据类型，JSON,HL7,XML</wsdl:documentation>
      <wsdl:input message="tns:TransferHerenSoapIn" />
      <wsdl:output message="tns:TransferHerenSoapOut" />
    </wsdl:operation>
    <wsdl:operation name="WebTest">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">----用于开发人员测试，参数传入时</wsdl:documentation>
      <wsdl:input message="tns:WebTestSoapIn" />
      <wsdl:output message="tns:WebTestSoapOut" />
    </wsdl:operation>
    <wsdl:operation name="QueryCov19">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">----核酸结果查询，JSON</wsdl:documentation>
      <wsdl:input message="tns:QueryCov19SoapIn" />
      <wsdl:output message="tns:QueryCov19SoapOut" />
    </wsdl:operation>
  </wsdl:portType>
  <wsdl:portType name="WebServiceLisHttpGet">
    ...
    <wsdl:operation name="TransferHeren">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">----用于向和仁直接转发消息，strMessage 消息内容，strDataType数据类型，JSON,HL7,XML</wsdl:documentation>
      <wsdl:input message="tns:TransferHerenHttpGetIn" />
      <wsdl:output message="tns:TransferHerenHttpGetOut" />
    </wsdl:operation>
    <wsdl:operation name="WebTest">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">----用于开发人员测试，参数传入时</wsdl:documentation>
    ...
    <wsdl:operation name="QueryCov19">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">----核酸结果查询，JSON</wsdl:documentation>
      <wsdl:input message="tns:QueryCov19HttpGetIn" />
      <wsdl:output message="tns:QueryCov19HttpGetOut" />
    </wsdl:operation>
  </wsdl:portType>
  <wsdl:portType name="WebServiceLisHttpPost">
    ...
    <wsdl:operation name="TransferHeren">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">----用于向和仁直接转发消息，strMessage 消息内容，strDataType数据类型，JSON,HL7,XML</wsdl:documentation>
      <wsdl:input message="tns:TransferHerenHttpPostIn" />
      <wsdl:output message="tns:TransferHerenHttpPostOut" />
    </wsdl:operation>
    <wsdl:operation name="WebTest">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">----用于开发人员测试，参数传入时</wsdl:documentation>
    ...
    <wsdl:operation name="QueryCov19">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">----核酸结果查询，JSON</wsdl:documentation>
      <wsdl:input message="tns:QueryCov19HttpPostIn" />
      <wsdl:output message="tns:QueryCov19HttpPostOut" />
    </wsdl:operation>
  </wsdl:portType>
  <wsdl:binding name="WebServiceLisSoap" type="tns:WebServiceLisSoap">
    ...
    <wsdl:operation name="TransferHeren">
      <soap:operation soapAction="http://172.16.1.36/TransferHeren" style="document" />
      <wsdl:input>
        <soap:body use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="QueryCov19">
      <soap:operation soapAction="http://172.16.1.36/QueryCov19" style="document" />
      <wsdl:input>
        <soap:body use="literal" />
      </wsdl:input>
      <wsdl:output>
  ...
  <wsdl:binding name="WebServiceLisSoap12" type="tns:WebServiceLisSoap">
    ...
    <wsdl:operation name="TransferHeren">
      <soap12:operation soapAction="http://172.16.1.36/TransferHeren" style="document" />
      <wsdl:input>
        <soap12:body use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="QueryCov19">
      <soap12:operation soapAction="http://172.16.1.36/QueryCov19" style="document" />
      <wsdl:input>
        <soap12:body use="literal" />
      </wsdl:input>
      <wsdl:output>
  ...
  <wsdl:binding name="WebServiceLisHttpGet" type="tns:WebServiceLisHttpGet">
    ...
    <wsdl:operation name="TransferHeren">
      <http:operation location="/TransferHeren" />
      <wsdl:input>
        <http:urlEncoded />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="QueryCov19">
      <http:operation location="/QueryCov19" />
      <wsdl:input>
        <http:urlEncoded />
      </wsdl:input>
      <wsdl:output>
  ...
  <wsdl:service name="WebServiceLis">
    <wsdl:port name="WebServiceLisSoap" binding="tns:WebServiceLisSoap">
      <soap:address location="http://172.16.17.94:20202/WebServiceLis.asmx" />
    </wsdl:port>
    <wsdl:port name="WebServiceLisSoap12" binding="tns:WebServiceLisSoap12">
      <soap12:address location="http://172.16.17.94:20202/WebServiceLis.asmx" />
    </wsdl:port>
    <wsdl:port name="WebServiceLisHttpGet" binding="tns:WebServiceLisHttpGet">
      <http:address location="http://172.16.17.94:20202/WebServiceLis.asmx" />
    </wsdl:port>
